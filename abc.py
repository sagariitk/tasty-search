...
def return_result(dict1, objects):
    ...
    for i in sorted (dict1, reverse= True) : 
        if(j<20):
            ...
            abc = {"productId":product_productId, "userId": review_userId, "profileName": review_profileName, "score": review_score, "time": review_time, "summary": review_summary, "text": review_text}
            objects.append(abc)
            j = j + 1
        else:
            return  objects
